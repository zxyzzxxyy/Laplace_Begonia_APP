<template>
	<view class="container" :style="{height: height}"> 
		...
		<view class="tool-view" > 
			...
			<view class="tool">
				<jinIcon class="single" type="&#xe6f3;" font-size="40rpx" title="插入图片" @click="insertImage"></jinIcon>
				<jinIcon class="single" type="&#xe6f9;" font-size="40rpx" title="修改文字样式" @click="showMore" :color="showMoreTool ? activeColor : '#666666'"></jinIcon>
				<jinIcon class="single" type="&#xe6eb;" font-size="40rpx" title="分割线" @click="insertDivider"></jinIcon>
				<jinIcon class="single" type="&#xe6e8;" font-size="40rpx" title="撤销" @click="undo"></jinIcon>
				<jinIcon class="single" type="&#xe705;" font-size="40rpx" title="重做" @click="redo"></jinIcon>
				<jinIcon class="single" type="&#xeb8a;" font-size="40rpx" title="设置" @click="showSetting"></jinIcon>
			</view>
		</view>
	</view>
</template>
						...
						await uni.uploadFile({
							...
							success: res => {
								...
								this.editorCtx.insertImage({
									src: res.data.location,  // 此处需要将图片地址切换成服务器返回的真实图片地址
									alt: '图片',
									success: function(e) {}
								});
								uni.hideLoading()
